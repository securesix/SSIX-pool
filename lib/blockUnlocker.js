    ...
    async.waterfall([
        ...
        function(blocks, callback){
            ...
            blocks.forEach(function(block){
                ...
                log('info', logSystem, 'Unlocked %d block with reward %d and donation fee %d. Miners reward: %d, solver reward: %d', [block.height, block.reward, feePercent, reward, solverReward]);
