...
If you want to support development of bittorium-pool, you can send donations using following addresses or set "devDonation" to non-zero in [config.json](//github.com/mtl1979/bittorium-pool/blob/master/config.json#L111):
